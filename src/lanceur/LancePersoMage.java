...
public class LancePersoMage {
	private static String usage = "USAGE : java " + LancePersoMage.class.getName() + " [ port [ ipArene ] ]";
	...
	public static void main(String[] args) {
		...
		try {
			...
			caracts.put(Caracteristique.INITIATIVE, 180);
			...
			logger.info("Lanceur", "Creation du personnage mage reussie");
