...
public class LancePotionInit {
	...
	public static void main(String[] args) {
		...
		try {
			...
			logger.info("Lanceur", "Lancement de la potion init sur le serveur...");
			...
			caractsPotion.put(Caracteristique.INITIATIVE, 50);
			...
			logger.info("Lanceur", "Lancement de la potion init reussi");
