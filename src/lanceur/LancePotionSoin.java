...
public class LancePotionSoin {
	
	private static String usage = "USAGE : java " + LancePotionSoin.class.getName() + " [ port [ ipArene ] ]";
	...
	public static void main(String[] args) {
		...
		try {
			...
			logger.info("Lanceur", "Lancement de la potion soin sur le serveur...");
