...
public class LancePotionPuissance {
	private static String usage = "USAGE : java " + LancePotionPuissance.class.getName() + " [ port [ ipArene ] ]";
	
	public static void main(String[] args) {
		String nom = "Puissance";
		...
		try {
			...
			logger.info("Lanceur", "Lancement de la potion puissance sur le serveur...");
			...
			logger.info("Lanceur", "Lancement de la potion puissance reussi");
