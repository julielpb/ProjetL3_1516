...
import client.StrategiePersoVampire;
...
public class LancePersoVampire {
	private static String usage = "USAGE : java " + LancePersoVampire.class.getName() + " [ port [ ipArene ] ]";
	...
	public static void main(String[] args) {
		...
		try {
			...
			new StrategiePersoVampire(ipArene, port, ipConsole, new Vampire(nom, groupe, caracts), nbTours, position, logger);
			logger.info("Lanceur", "Creation du personnage vampire reussie");
