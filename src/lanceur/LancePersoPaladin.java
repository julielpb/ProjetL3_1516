...
public class LancePersoPaladin {
	private static String usage = "USAGE : java " + LancePersoPaladin.class.getName() + " [ port [ ipArene ] ]";
	...
	public static void main(String[] args) {
		...
		try {
			...
			logger.info("Lanceur", "Creation du personnage paladin reussie");
