...
public class LancePersoBarbare {
	private static String usage = "USAGE : java " + LancePersoBarbare.class.getName() + " [ port [ ipArene ] ]";
	...
	public static void main(String[] args) {
		...
		try {
			...
			logger.info("Lanceur", "Creation du personnage barbare reussie");
